...
function App() {
  ...
  const updateAssessment = (regId, newChanges, newGapScore) => {
    const patch = (r) => ({ ...r, changes: newChanges, gapScore: newGapScore });
  ...
  return (
    <div className="app">
      ...
      <main className="main" data-screen-label={route}>
        ...
        {route === "detail" && <DetailPage reg={currentReg} onBack={() => setRoute("dashboard")} onStatusChange={updateGapStatus} onAssessmentUpdate={updateAssessment}/>}
      </main>
